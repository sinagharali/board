...
- A user can be the invitee in an invitation if they are a user.

- A user can be the invited_by in an invitation if they are a user and have invite_users permission from the board.
